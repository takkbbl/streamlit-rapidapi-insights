...
def plot_payout_amount_by_month(df) -> None:
    ...
    df_2024 = df[df['createdAt'].dt.year == 2024]
    ...
    payout_by_month_2024 = df_2024.groupby([df['createdAt'].dt.month]).agg(sum_payout=('payoutAmount', 'sum'))
    ...
    payout_by_month_2024.index = "2024-" + payout_by_month_2024.index.astype(str)
    payout_by_month_2024.index = pd.to_datetime(payout_by_month_2024.index)
    payout_by_month_all = pd.concat([payout_by_month_2021, payout_by_month_2022, payout_by_month_2023, payout_by_month_2024], axis=0)
